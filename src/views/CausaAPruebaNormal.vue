      ...
      <v-row>
        ...
        <v-col sm="6" md="6" lg="6">
          ...
          <div ref="ResolucionText" class="resolucion-texto">
            <p><strong>Resolviendo presentación de fecha 10 de agosto de 2024, de folio 25:</strong></p>
            <p>Como se pide, atendido el tiempo transcurrido, téngase por evacuado el traslado conferido por resolución de folio 13, en rebeldía de la parte demandante. Estese a lo que se resolverá.</p>
            ...
            <p>En caso que las partes ofrezcan prueba testimonial y/o confesional dentro del plazo legal, esta se rendirá en forma presencial en el tribunal los últimos tres días del probatorio a las 9:30 horas, principiando con el demandante.</p>
    ...
    methods: {
      generarTexto(excepcion) {
        if (excepcion === 'Incompetencia') {
          ...
          return 'Texto para Pago de la deuda';
      ...
      copyToClipboard() {
        const textToCopy = this.$refs.ResolucionText.innerText;
