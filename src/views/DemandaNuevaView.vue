<template>
  ...
  computed: {
    formattedText() {
      ...
      for (let i = 0; i < otrosiLabels.length; i++) {
        ...
        if (option) {
          if (currentOption === null) {
            ...
            // Añadir label al grupo actual
            currentLabels.push(label);
          } else {
            // Generar texto para el grupo actual
      ...
      // Procesar último grupo si existe
      ...
      // Construir el HTML final incluyendo "CUANTÍA:" en negrita
      let finalHtml = '';
  ...
  methods: {
    combineLabels(labels) {
      ...
      // Reconstruir el label combinado
